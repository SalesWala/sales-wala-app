...
const calcAnimatedPropsRightToLeft = (
  ...
  const cx = interpolate(
    sharedValue.value,
    inputRangePosition,
    [VIEWBOX_WIDTH - BASE_RADIUS, BASE_RADIUS],
    Extrapolate.CLAMP,
  );
  const d = interpolate(
    sharedValue.value,
    inputRangeDiameter,
    [BASE_DIAMETER, BASE_DIAMETER * 0.6, BASE_DIAMETER],
    Extrapolate.CLAMP,
  );
  return {
    cx: cx,
...
const calcAnimatedPropsLefttoRight = (
  sharedValue: Animated.SharedValue<number>,
  firstPart: boolean,
) => {
  'worklet';
  ...
  const cx = interpolate(
    sharedValue.value,
    inputRangePosition,
    [BASE_RADIUS, VIEWBOX_WIDTH - BASE_RADIUS],
    Extrapolate.CLAMP,
  );
  const d = interpolate(
    sharedValue.value,
    inputRangeDiameter,
    [BASE_DIAMETER, BASE_DIAMETER * 1.2, BASE_DIAMETER],
    Extrapolate.CLAMP,
  );
  return {
    cx: cx,
...
const LoadingSpinner = () => {
  ...
  useEffect(() => {
    ...
    animatedValue.value = withRepeat(
      withTiming(2, {duration: 900, easing: Easing.linear}),
      -1,
      false,
    );
    return () => {
  ...
  return (
    <Svg height="40" width="40" viewBox="0 0 100 100">
      ...
      <AnimatedG animatedProps={group1Props}>
        {/* left circle */}
        <AnimatedCircle
          animatedProps={group1LeftToRightCircleProps}
          cy="50"
          fill={RED_COLOR}
        />
        ...
        {/* right circle */}
        <AnimatedCircle
          animatedProps={group1RightToLeftCircleProps}
          cy="50"
          fill={GREEN_COLOR}
        />
        ...
        <AnimatedCircle
          animatedProps={group1LeftToRightBackgroundCircleProps}
          cy="50"
          fill={BACKGROUND_COLOR}
          clipPath="url(#group1-background-clippath)"
        />
      </AnimatedG>
      ...
      <AnimatedG animatedProps={group2Props}>
        ...
        <AnimatedCircle
          animatedProps={group2LeftToRightCircleProps}
          cy="50"
          fill={GREEN_COLOR}
        />
        ...
        <AnimatedCircle
          animatedProps={group2RightToLeftCircleProps}
          cy="50"
          fill={RED_COLOR}
        />
        ...
        {/* left circle with background color */}
        <AnimatedCircle
          animatedProps={group2LeftToRightBackgroundCircleProps}
          cy="50"
          fill={BACKGROUND_COLOR}
          clipPath="url(#group2-background-clippath)"
        />
      </AnimatedG>
    </Svg>
  );
